...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table "collected_coin", primary_key: "ID", id: :integer, charset: "latin1", force: :cascade do |t|
    t.integer "USER_ID", null: false
    t.integer "VALUE_COIN", null: false
    t.index ["USER_ID"], name: "USER_ID"
  end

  create_table "deaths", primary_key: "ID", id: :integer, charset: "latin1", force: :cascade do |t|
    t.integer "USER_ID", null: false
    t.timestamp "TIME_REG", default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.index ["USER_ID"], name: "USER_ID"
  end

  create_table "killed_monster", primary_key: "ID", id: :integer, charset: "latin1", force: :cascade do |t|
    t.integer "USER_ID", null: false
  ...
  create_table "monster", primary_key: "ID", id: :integer, charset: "latin1", force: :cascade do |t|
    t.string "NAME", limit: 150
  end

  create_table "trophy", primary_key: "ID", id: :integer, charset: "latin1", force: :cascade do |t|
    t.string "NAME", limit: 45
  end

  create_table "user_trophy", primary_key: "ID", id: :integer, charset: "latin1", force: :cascade do |t|
    t.integer "USER_ID", null: false
  ...
  add_foreign_key "killed_monster", "monster", column: "MONSTER_ID", primary_key: "ID", name: "killed_monster_ibfk_2"
